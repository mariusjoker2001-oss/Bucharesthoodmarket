...
const INVENTORY_ITEMS = [
...
];const INVENTORY_ITEMS = [
  {
    id: "1",
    name: "Cat Grass",
    description: "From Spain - make your cat relaxed and calm",
    priceBTC: 0.00015,
    priceETH: 0.005,
    priceUSDT: 15,
    available: true,
  ...
  },
  {
    id: "2",
    name: "Nurofen",
    description: "From Amsterdam - feel good at any party. If you're sick or got any pain, it will make you feel normal again",
    priceBTC: 0.00015,
    priceETH: 0.005,
    priceUSDT: 15,
    available: true,
